...
{
    public class GetMyTicketsQueryHandler:IRequestHandler<GetMyTicketsQuery,List<GetMyTicketDto>>
    {
        ...
        public async Task<List<GetMyTicketDto>> Handle(GetMyTicketsQuery request, CancellationToken cancellationToken)
        {
            ...
            return TicketMapper.TicketsToMyTicketsDto(query.ToList()).ToList();
        }
    }
}
