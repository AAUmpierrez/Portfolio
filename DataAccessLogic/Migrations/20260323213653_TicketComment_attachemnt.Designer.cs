...
namespace DataAccessLogic.Migrations
{
    ...
    [Migration("20260323213653_TicketComment_attachemnt")]
    partial class TicketComment_attachemnt
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("BussinesLogic.Entities.Ticket", b =>
                {
                    b.HasOne("BussinesLogic.Entities.User", "AssignedByUser")
                        .WithMany()
            ...
            modelBuilder.Entity("BussinesLogic.Entities.TicketAttachment", b =>
                {
                    b.HasOne("BussinesLogic.Entities.TicketComment", "TicketComment")
                        .WithMany("Attachments")
                        .HasForeignKey("TicketCommentId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("BussinesLogic.Entities.Ticket", null)
                        .WithMany("Attachments")
